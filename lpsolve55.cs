...
namespace lpsolve55
{
    public static class lpsolve
    {
        ...
        //[DllImport("lpsolve55.dll", SetLastError=true)]
        //public static extern string get_col_name(int lp, int column);
        ...
        //[DllImport("lpsolve55.dll", SetLastError=true)]
        //public static extern string get_lp_name(int lp);
        ...
        //[DllImport("lpsolve55.dll", SetLastError=true)]
        //public static extern string get_origcol_name(int lp, int column);
        ...
        //[DllImport("lpsolve55.dll", SetLastError=true)]
        //public static extern string get_origrow_name(int lp, int row);
        ...
        //[DllImport("lpsolve55.dll", SetLastError=true)]
        //public static extern string get_row_name(int lp, int row);
        ...
        //[DllImport("lpsolve55.dll", SetLastError=true)]
        //public static extern string get_statustext(int lp, int statuscode);
